...
#เขียนโปรแกรมคำนวนผลการเรียนโดยรับค่าอินพุตคะแนน 1 ตัวที่เป็นจำนวนจริง จากนั้นตรวจสอบค่าคะแนนดังต่อไปนี้
    ...
    #•ถ้าคะแนนน้อยกว่า 49.99 ให้พิมพ์ F# Question 5

print("ระะบบป้อนค่าคะเเนน\n")
age = float(input("กรุณาป้อนค่าคะเเนน: "))
if age >= 80:
    print("A")
    ...
    print("C+")
elif age >= 60.0 and  age < 54.99:
    print("C")
elif age >= 55.0 and  age < 55.99:
    print("D+")
